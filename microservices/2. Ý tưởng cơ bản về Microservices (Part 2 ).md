...
1. Cách chúng ta lưu trữ dữ liệu bên trong một service sẽ như thế nào?
2. Cách chúng ta giao tiếp, chia sẻ dữ liệu giữa các service khác nhau sẽ ra sao?
...
Giả sử bạn có tất cả service cùng dùng chung một database. Nếu database đó gặp trục trặc, toàn bộ hệ thống sẽ sập.

![image.png](https://images.viblo.asia/318582b4-8f1a-4082-a9f3-863345825484.png)Không chỉ vậy, việc scale (mở rộng) database chung này sẽ rất khó khăn.
...
Lỗi này rất khó debug, vì nó không đến từ service Actor hay service Code, cũng không phải lỗi hệ thống... mà là do sự thay đổi không được đồng bộ giữa các team.
